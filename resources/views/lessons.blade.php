    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <h1 class="text-3xl font-bold mb-3">Units Lesson Page</h1>
                <p class="mb-4 text-gray-600">Manage Units Lesson on Calisfun</p>

                <!-- Search input -->
                <div class="relative m-[2px] mb-3 mr-5 float-left">
                    <label for="inputSearch" class="sr-only">Search </label>
                    <input id="inputSearch" type="text" placeholder="Search..." class="block w-64 rounded-lg border py-2 pl-10 pr-4 text-sm focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-400" />
                    <span class="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 transform">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4 text-neutral-500">
                ...
                <table class="min-w-full text-left text-sm whitespace-nowrap">
                    ...
                    <tbody>
                        <tr class="border-b hover:bg-neutral-100">
                            ...
                            <td class="border-b px-4 py-2">
                                <div class="relative">
                                    ...
                                    <!-- Dropdown menu -->
                                    <div
                                        class="absolute right-[80px] top-0 mt-2 w-32 bg-white border rounded-md shadow-lg hidden"
                                        id="dropdownMenu"
                                    >
                                        <a
                                            href="#"
                        ...
                        <tr class="border-b hover:bg-neutral-100">
                            ...
                            <td class="px-6 py-4">Lesson 3</td>
        ...
        <div class="mt-8 text-left">
            <a href="{{ route('units.create') }}"class="bg-blue-600 text-white px-4 py-2 rounded">Create New Unit Lesson</a>
        </div>
        </div>
    </div>
</x-app-layout>