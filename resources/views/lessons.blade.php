        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 overflow-x-auto bg-white">
                    ...
                    <p class="mb-4 text-gray-600">Manage Lesson on Calisfun</p>
...
<div class="relative m-[2px] mb-3 mr-5 float-left">
    ...
    <form action="{{ route('lessons.search') }}" method="GET">
                    ...
                    <tr class="border-b hover:bg-neutral-100">
                        ...
                        <td class="border-b px-4 py-4"> <!-- Mengurangi padding -->
                            <div class="relative">
                                ...
                                <!-- Dropdown menu -->
                                <div
                                    class="absolute right-20 top-0 w-32 bg-white border rounded-md shadow-lg hidden"
                                    id="dropdownMenu"
                                >
                                    <a
        ...
        <div class="mt-8 text-left">
            <a href="{{ route('lessons.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded">Create New lesson</a>
        </div>
        </div>
    </div>
</x-app-layout>
