        ...
        <div class="flex items-center justify-center py-14 bg-gray-100">
            <div class="bg-white shadow-md rounded-lg px-10 py-8 w-9/12">
                <div class="container mx-auto p-2">
                    <h1 class="text-2xl font-bold mb-1">Edit Unit Lesson</h1>
                    <p class="text-gray-500 mb-6">Edit Unit Lesson on Calisfun</p>
                    ...
                    <form action="" method="POST">
                        ...
                        <!-- Unit Lesson Title -->
                        <div class="mb-4">
                            <label for="unit-title" class="block text-sm font-medium text-gray-700">Unit Lesson Title</label>
                        ...
                        <div class="mb-6">
                            ...
                            <select id="unit-reference" name="reference"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-400 focus:ring focus:ring-blue-300 px-3 py-2 text-sm">
                                <option value="Easy">Unit 1</option>
                                <option value="Medium">Unit 2</option>
                                <option value="Hard">Unit 3</option>
                            </select>
                        </div>
