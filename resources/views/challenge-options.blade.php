        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="relative m-[2px] mb-3 mr-5 float-left">
                    ...
                    <form action="{{ route('challenge-options.search') }}" method="GET">
                        <input 
                            id="inputSearch" 
                            name="search"
                            type="text" 
                ...
                <table class="min-w-full text-left text-sm whitespace-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-neutral-100">
                            <th scope="row" class="px-6 py-4">{{ $challengeOption->id }}</th>
                            <td class="px-6 py-4">{{ $challengeOption->text }}</td>
                            <td class="px-6 py-4">{{ $challengeOption->challenge_id }}</td>
                            <td class="px-6 py-4">
                                <div class="relative">
                                    ...
                                    >
                                        <a
                                            href="{{ route('challenge-options.edit', $challengeOption->id) }}"
                                        ...
                                        <form action="{{ route('challenge-options.destroy', $challengeOption->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this course?')">
                                            @csrf
                                            @method('DELETE')
                                            <button
                                                type="submit"
