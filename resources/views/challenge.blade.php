        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 overflow-x-auto bg-white">
                    ...
                    <p class="mb-4 text-gray-600">Manage Chalenge on Calisfun</p>
...
<div class="relative m-[2px] mb-3 mr-5 float-left">
    ...
    <form action="{{ route('challenges.search') }}" method="GET">
        <input 
            id="inputSearch" 
            name="search"
            type="text" 
                ...
                <table class="min-w-full text-left text-sm whitespace-nowrap">
                    ...
                    @foreach($challenges as $challenge)
                        <tr class="border-b hover:bg-neutral-100">
                            <th scope="row" class="px-6 py-4">{{ $challenge->id }}</th>
                            ...
                            <td class="border-b px-4 py-6">
                                <div class="relative m-[-13px]">
                                    ...
                                    >
                                        ...
                                        <form action="{{ route('challenges.destroy', $challenge->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this course?')">
                                            @csrf
                                            @method('DELETE')
                                            <button
                                                type="submit"
        ...
        <div class="mt-8 text-left">
            <a href="{{ route('challenges.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded">Create New Challenge</a>
        </div>
        </div>
    </div>
</x-app-layout>
