    ...
    <div class="flex items-center justify-center py-14 bg-gray-100">
        <div class="bg-white shadow-md rounded-lg px-10 py-8 w-9/12">
            <div class="container mx-auto p-2">
                <h1 class="text-2xl font-bold mb-1">Create New Lesson</h1>
                <p class="text-gray-500 mb-6">Fill in the details below to create a new lesson</p>

                <!-- Form untuk membuat lesson baru -->
